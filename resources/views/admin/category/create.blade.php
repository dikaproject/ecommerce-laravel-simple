...
@section('content-title', 'Tambah Kategori Baru')
...
<div class="admin-card">
    <div class="admin-card-header">
        <h5 class="admin-card-title">Tambah Kategori Baru</h5>
    </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <!-- Gambar Kategori -->
                    <div class="mb-3">
                        <label for="image" class="form-label required-label">Gambar Kategori</label>
            ...
            <div class="d-flex justify-content-end mt-3">
                ...
                <button type="submit" class="btn btn-danger">Simpan Kategori</button>
            </div>
        </form>
    </div>
</div>
